...
- Added focused root, `/core`, and `/kit` entry points; shared conversation and
  renderer primitives; retry and localization APIs; safe rich Markdown;
  reader-aware streaming and multiline/copy UX; complete UI and attribution
  localization; accessible modal isolation; and live `data-*` updates.
