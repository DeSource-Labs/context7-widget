(function(){var e=`<svg class="c7-brand-logo c7-brand-logo--context7" aria-hidden="true" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,t=`data:image/png;base64,`,n=e,r=t;function i(){return`
    <a
      class="c7-brand-link"
  ...
  `}var a=/^https?:\/\//i;function o(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}function s(e){let t=e.replace(/\r\n/g,`
`).split(`
`),n=[],r=[],i=null,a=null;function s(){r.length!==0&&(n.push(`<p>${r.join(` `)}</p>`),r=[])}function l(){i&&(n.push(`</${i}>`),i=null)}function u(e){i!==e&&(l(),n.push(`<${e}>`),i=e)}for(let e of t){if(e.match(/^```/)){a?(n.push(`<pre part="code-block"><code>${o(a.join(`
`).trim())}</code></pre>`),a=null):(s(),l(),a=[]);continue}if(a){a.push(e);continue}let t=e.trim();if(!t){s(),l();continue}let i=t.match(/^[-*]\s+(.+)/);if(i){s(),u(`ul`),n.push(`<li>${c(i[1]??``)}</li>`);continue}let d=t.match(/^\d+\.\s+(.+)/);if(d){s(),u(`ol`),n.push(`<li>${c(d[1]??``)}</li>`);continue}let f=t.match(/^#{1,4}\s+(.+)/);if(f){s(),l(),n.push(`<p><strong>${c(f[1]??``)}</strong></p>`);continue}l(),r.push(c(t))}return a&&n.push(`<pre part="code-block"><code>${o(a.join(`
`).trim())}</code></pre>`),s(),l(),n.join(``)}function c(e){return o(e).replace(/`([^`]+)`/g,`<code>$1</code>`).replace(/\*\*([^*]+)\*\*/g,`<strong>$1</strong>`).replace(/\*([^*]+)\*/g,`<em>$1</em>`).replace(/\[([^\]]+)]\(([^)]+)\)/g,(e,t,n)=>a.test(n)?`<a href="${n}" target="_blank" rel="noopener noreferrer">${t}</a>`:t)}function l(e,t){let n=o(e||`Something went wrong.`),r=t.startsWith(`/`)?t:`/${t}`;return`${n}<br><br>If you are the library owner, check your <a href="${o(encodeURI(`https://context7.com${r}/admin?tab=chat`))}" target="_blank" rel="noopener noreferrer">widget settings</a> on Context7.`}function u(e){return e instanceof DOMException&&e.name===`AbortError`}var d=`
  :host {
    --c7-accent: #059669;
...
`,f=`https://context7.com/api/v2/widget/chat`,p=class extends Error{constructor(e){super(e),this.name=`Context7TransportError`}};async function m(e,t,n,r){let i=(await h(e,t,r)).body?.getReader();if(!i)throw new p(`No response stream was returned.`);let a=new TextDecoder,o=``;for(;;){let{done:e,value:t}=await i.read();if(e)break;o+=a.decode(t,{stream:!0});let r=o.split(`
`);o=r.pop()??``;for(let e of r)g(e,n)}o.trim()&&g(o,n)}async function h(e,t,n){let r;try{r=await fetch(f,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({libraryName:e.library,messages:t.map(e=>({id:e.id,role:e.role,content:e.content,parts:[{type:`text`,text:e.content}]}))}),signal:n})}catch(e){throw S(e)?e:new p(`Unable to connect to the Context7 chat service.`)}if(!r.ok)throw new p(await b(r));return r}function g(e,t){let n=e.trim();if(!n||n===`data: [DONE]`)return;if(n.startsWith(`data:`)){_(n.slice(5).trim(),t);return}let r=n.indexOf(`:`);if(r===-1)return;let i=n.slice(0,r),a=n.slice(r+1);if(i===`0`)try{let e=JSON.parse(a);typeof e==`string`&&t.onChunk(e),typeof e?.content==`string`&&t.onChunk(e.content),typeof e?.delta==`string`&&t.onChunk(e.delta)}catch{}}function _(e,t){try{let n=JSON.parse(e);if(n.type===`text-delta`&&typeof n.delta==`string`){t.onChunk(n.delta);return}if(n.type===`tool-input-available`){t.onToolCall?.(v(n));return}n.type===`tool-output-available`&&t.onToolResult?.(y(n))}catch{}}function v(e){return{args:x(e.input)?e.input:{},toolCallId:String(e.toolCallId??``),toolName:String(e.toolName??`tool`)}}function y(e){return{result:e.output,toolCallId:String(e.toolCallId??``)}}async function b(e){try{let t=await e.json();if(t.message===`Widget is not enabled`)return`The chat widget is not enabled for this library.`;if(t.message===`Origin not allowed`)return`This domain is not authorized to use the chat widget.`;if(t.message)return t.message}catch{}return`Context7 chat request failed with HTTP ${e.status}.`}function x(e){return!!e&&typeof e==`object`&&!Array.isArray(e)}function S(e){return e instanceof DOMException&&e.name===`AbortError`}var C,w=new Map,T=typeof HTMLElement>`u`?class{}:HTMLElement,E=!1,D=class extends T{constructor(){super(),this.abortController=null,this.busy=!1,this.config=M(this),this.lastFocus=null,this.messageCounter=0,this.messages=[],this.registeredId=``,this.activeAnchorElement=null,this.toolCalls=new Map,this.triggerElement=null,this.onCustomTrigger=e=>{e.preventDefault(),this.activeAnchorElement=e.currentTarget instanceof Element?e.currentTarget:this.triggerElement,this.toggle()},this.onLauncherClick=e=>{this.activeAnchorElement=e.currentTarget instanceof Element?e.currentTarget:this.launcher,this.toggle()},this.onBackdropClick=e=>{e.target===this.backdrop&&this.config.closeOnOutsideClick&&this.close()},this.onDocumentPointerDown=e=>{if(!this.isOpen()||!this.config.closeOnOutsideClick)return;let t=e.composedPath();t.includes(this)||this.triggerElement&&t.includes(this.triggerElement)||this.close()},this.onFloatingLayout=()=>{this.isOpen()&&this.updateAnchorPosition()},this.onKeyDown=e=>{if(e.key===`Escape`&&this.isOpen()){e.preventDefault(),this.close();return}e.key!==`Tab`||!this.isOpen()||G(e,this.root)},this.root=this.attachShadow({mode:`open`}),this.renderShell()}connectedCallback(){this.syncConfig(),this.bindEvents(),this.bindCustomTrigger(),this.resetConversation(),this.register(),this.emit(`c7:ready`),this.config.defaultOpen&&this.open()}disconnectedCallback(){this.abortController?.abort(),this.unbindFloatingListeners(),this.unbindCustomTrigger(),this.unregister()}attributeChangedCallback(){let e=this.config.library;this.syncConfig(),this.updateStaticText(),this.bindCustomTrigger(),this.register(),this.messages.length<=1&&e!==this.config.library&&this.resetConversation(),this.config.defaultOpen&&!this.isOpen()?this.open():this.isOpen()&&(this.unbindFloatingListeners(),this.bindFloatingListeners(),this.updateAnchorPosition())}open(){this.isOpen()||(this.lastFocus=document.activeElement,this.updateAnchorPosition(),this.setAttribute(`open`,``),this.bindFloatingListeners(),this.emit(`c7:open`),window.setTimeout(()=>this.input?.focus(),20))}close(){this.isOpen()&&(this.removeAttribute(`open`),this.unbindFloatingListeners(),this.emit(`c7:close`),this.lastFocus instanceof HTMLElement&&this.lastFocus.focus())}toggle(){this.isOpen()?this.close():this.open()}isOpen(){return this.hasAttribute(`open`)}cancel(){this.abortController?.abort(),this.abortController=null,this.setBusy(!1)}async send(e){let t=(e??this.input?.value??``).trim();if(!t||this.busy)return;if(!this.config.library){this.appendError(`Missing data-library attribute.`);return}this.open(),this.setBusy(!0),this.input.value=``;let n={id:this.nextMessageId(),role:`user`,content:t};this.messages.push(n),this.appendMessage(`user`,o(t)),this.emit(`c7:question`,{message:n,messages:[...this.messages],question:t});let r=this.appendTyping(),i=``,a=null,c=!1;this.abortController=new AbortController;try{if(await m(this.config,this.messages,{onChunk:e=>{r.remove(),i+=e,a||(a=this.appendMessage(`assistant`,``)),a.innerHTML=s(i),c||(c=!0,this.emit(`c7:first-token`,{answer:i,question:t})),this.emit(`c7:answer`,{answer:i,question:t}),this.scrollToBottom()},onToolCall:e=>{r.remove(),this.appendToolCall(e),this.emit(`c7:tool-call`,{question:t,toolCall:e})},onToolResult:e=>{this.updateToolResult(e),this.emit(`c7:tool-result`,{question:t,toolResult:e})}},this.abortController.signal),r.remove(),i){let e={id:this.nextMessageId(),role:`assistant`,content:i};this.messages.push(e),this.emit(`c7:answer-complete`,{answer:i,message:e,messages:[...this.messages],question:t})}}catch(e){if(r.remove(),!u(e)){let n=e instanceof p||e instanceof Error?e.message:`Something went wrong.`;this.appendError(n),this.emit(`c7:error`,{error:n,question:t})}}finally{this.abortController=null,this.setBusy(!1),this.input?.focus()}}renderShell(){this.root.innerHTML=`
      <style>${d}</style>
    ...
    `}bindEvents(){this.backdrop?.addEventListener(`click`,this.onBackdropClick),this.launcher?.addEventListener(`click`,this.onLauncherClick),this.closeButton?.addEventListener(`click`,()=>this.close()),this.form?.addEventListener(`submit`,e=>{e.preventDefault(),this.send()}),this.root.addEventListener(`keydown`,this.onKeyDown)}syncConfig(){this.config=M(this),H(this,`--c7-accent`,this.config.color),H(this,`--c7-panel-height`,this.config.panelHeight),H(this,`--c7-panel-width`,this.config.panelWidth),B(this,`launcher-variant`,this.config.launcherVariant),B(this,`position`,this.config.position),B(this,`preset`,this.config.preset),B(this,`theme`,this.config.theme),V(this,`backdrop-active`,this.config.backdrop),V(this,`custom-trigger-active`,!!this.config.customTrigger)}updateStaticText(){this.titleElement&&(this.titleElement.textContent=this.config.title),this.input&&(this.input.placeholder=this.config.placeholder),this.launcherLabelElement&&(this.launcherLabelElement.textContent=this.config.launcherLabel),this.launcher&&this.launcher.setAttribute(`aria-label`,this.config.launcherLabel),this.panel&&(this.panel.setAttribute(`aria-label`,this.config.title),this.panel.setAttribute(`aria-modal`,String(this.config.position===`center`)))}resetConversation(){this.messages=[],this.toolCalls.clear(),this.messagesElement.innerHTML=``;let e=this.config.initialMessage.replace(/\{library\}/g,this.config.library||`this library`);this.appendMessage(`assistant`,s(e))}appendMessage(e,t){let n=document.createElement(`div`);return n.className=`c7-message c7-message--${e}`,n.setAttribute(`part`,`message ${e}-message`),n.innerHTML=t,this.messagesElement.append(n),this.scrollToBottom(),n}appendError(e){let t=document.createElement(`div`);t.className=`c7-message c7-message--error`,t.setAttribute(`part`,`message error-message`),t.innerHTML=l(e,this.config.library),this.messagesElement.append(t),this.scrollToBottom()}appendTyping(){let e=document.createElement(`div`);return e.className=`c7-typing`,e.setAttribute(`part`,`typing`),e.innerHTML=`<span></span><span></span><span></span>`,this.messagesElement.append(e),this.scrollToBottom(),e}appendToolCall(e){let t=document.createElement(`div`),n=typeof e.args.query==`string`?e.args.query:`documentation`;t.className=`c7-tool-call`,t.setAttribute(`part`,`tool-call`),t.innerHTML=`
      <div class="c7-tool-header">
        <svg viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="2">
          <circle cx="11" cy="11" r="8"></circle>
          <path d="m21 21-4.35-4.35"></path>
        </svg>
        <span>Searching: ${o(n)}</span>
    ...
    `,this.toolCalls.set(e.toolCallId,t),this.messagesElement.append(t),this.scrollToBottom()}updateToolResult(e){let t=this.toolCalls.get(e.toolCallId);if(!t)return;t.querySelector(`[data-c7-tool-spinner]`)?.remove();let n=typeof e.result==`string`?e.result:JSON.stringify(e.result,null,2);if(!n)return;let r=document.createElement(`div`);r.className=`c7-tool-result`,r.innerHTML=`
    ...
    `;let i=r.querySelector(`.c7-tool-toggle`),a=r.querySelector(`.c7-tool-content`);i?.addEventListener(`click`,()=>{if(!i||!a)return;let e=i.getAttribute(`aria-expanded`)===`true`;i.setAttribute(`aria-expanded`,String(!e)),a.hidden=e}),t.append(r),this.scrollToBottom()}setBusy(e){this.busy=e,this.input&&(this.input.disabled=e),this.sendButton&&(this.sendButton.disabled=e)}scrollToBottom(){this.messagesElement.scrollTop=this.messagesElement.scrollHeight}bindFloatingListeners(){document.addEventListener(`pointerdown`,this.onDocumentPointerDown,!0),this.config.position===`anchor`&&(window.addEventListener(`resize`,this.onFloatingLayout),window.addEventListener(`scroll`,this.onFloatingLayout,!0))}unbindFloatingListeners(){document.removeEventListener(`pointerdown`,this.onDocumentPointerDown,!0),window.removeEventListener(`resize`,this.onFloatingLayout),window.removeEventListener(`scroll`,this.onFloatingLayout,!0)}updateAnchorPosition(){if(this.config.position!==`anchor`)return;let e=this.getAnchorElement(),t=this.panel;if(!e||!t)return;let n=e.getBoundingClientRect(),r=t.offsetWidth||400,i=t.offsetHeight||600,a=window.innerWidth||document.documentElement.clientWidth||r,o=window.innerHeight||document.documentElement.clientHeight||i,s=n.right-r,{top:c,origin:l}=U(n,i,o,12,12,`right`),u=Math.max(12,a-r-12),d=Math.max(12,o-i-12);s=W(s,12,u),c=W(c,12,d),this.style.setProperty(`--c7-anchor-left`,`${s}px`),this.style.setProperty(`--c7-anchor-top`,`${c}px`),this.style.setProperty(`--c7-anchor-origin`,l)}getAnchorElement(){return this.activeAnchorElement instanceof HTMLElement&&this.activeAnchorElement.isConnected?this.activeAnchorElement:this.triggerElement instanceof HTMLElement?this.triggerElement:this.launcher}bindCustomTrigger(){this.unbindCustomTrigger(),this.config.customTrigger&&(this.triggerElement=document.querySelector(this.config.customTrigger),this.triggerElement?.addEventListener(`click`,this.onCustomTrigger))}unbindCustomTrigger(){this.activeAnchorElement===this.triggerElement&&(this.activeAnchorElement=null),this.triggerElement?.removeEventListener(`click`,this.onCustomTrigger),this.triggerElement=null}nextMessageId(){return this.messageCounter+=1,`c7m-${this.messageCounter}`}register(){k(),this.registeredId&&this.registeredId!==this.config.widgetId&&w.delete(this.registeredId),w.set(this.config.widgetId,this),this.registeredId=this.config.widgetId}unregister(){this.registeredId&&(w.get(this.registeredId)===this&&w.delete(this.registeredId),this.registeredId=``)}emit(e,t={}){this.dispatchEvent(new CustomEvent(e,{bubbles:!0,composed:!0,detail:{library:this.config.library,widget:this,widgetId:this.config.widgetId,...t}}))}get closeButton(){return this.root.querySelector(`[data-c7-close]`)}get backdrop(){return this.root.querySelector(`[data-c7-backdrop]`)}get form(){return this.root.querySelector(`[data-c7-form]`)}get input(){return this.root.querySelector(`[data-c7-input]`)}get launcher(){return this.root.querySelector(`[data-c7-launcher]`)}get launcherLabelElement(){return this.root.querySelector(`[data-c7-launcher-label]`)}get messagesElement(){return this.root.querySelector(`[data-c7-messages]`)}get panel(){return this.root.querySelector(`.c7-panel`)}get sendButton(){return this.root.querySelector(`[data-c7-send]`)}get titleElement(){return this.root.querySelector(`[data-c7-title]`)}};C=D,C.observedAttributes=`backdrop.close-on-outside-click.color.custom-trigger.data-backdrop.data-close-on-outside-click.data-color.data-custom-trigger.data-default-open.data-initial-message.data-launcher-label.data-launcher-variant.data-library.data-panel-height.data-panel-width.data-placeholder.data-position.data-preset.data-theme.data-title.data-welcome-message.data-widget-id.default-open.initial-message.launcher-label.launcher-variant.library.panel-height.panel-width.placeholder.position.preset.theme.title.widget-id`.split(`.`);function O(e=`context7-widget`){typeof customElements>`u`||customElements.get(e)||customElements.define(e,D)}function k(){E||typeof window>`u`||(window.Context7Widget={instances:w,close:e=>j(A(e))?.close(),get:e=>A(e),isOpen:e=>j(A(e))?.isOpen()??!1,open:e=>j(A(e))?.open(),send:async(e,t)=>{await j(A(t))?.send(e)},toggle:e=>j(A(e))?.toggle()},E=!0)}function A(e){return e?w.get(e):w.get(`default`)??w.values().next().value}function j(e){return e instanceof D?e:void 0}function M(e){let t=N(e,`library`,`data-library`),n=P(N(e,`position`,`data-position`));return{backdrop:R(e,n===`center`,`backdrop`,`data-backdrop`),closeOnOutsideClick:R(e,!0,`close-on-outside-click`,`data-close-on-outside-click`),color:N(e,`color`,`data-color`),customTrigger:N(e,`custom-trigger`,`data-custom-trigger`),defaultOpen:R(e,!1,`default-open`,`data-default-open`),initialMessage:N(e,`initial-message`,`data-initial-message`,`welcome-message`,`data-welcome-message`)||`Hello! I'm here to help you with documentation for **{library}**.

Ask me about features, code examples, setup, configuration, API details, or best practices.`,launcherLabel:N(e,`launcher-label`,`data-launcher-label`)||`Ask Docs AI`,launcherVariant:F(N(e,`launcher-variant`,`data-launcher-variant`)),library:t,panelHeight:N(e,`panel-height`,`data-panel-height`),panelWidth:N(e,`panel-width`,`data-panel-width`),placeholder:N(e,`placeholder`,`data-placeholder`)||`Ask about the docs...`,position:n,preset:I(N(e,`preset`,`data-preset`)),theme:L(N(e,`theme`,`data-theme`)),title:N(e,`title`,`data-title`)||`Chat with Documentation`,widgetId:N(e,`widget-id`,`data-widget-id`)||e.id||`default`}}function N(e,...t){for(let n of t){let t=e.getAttribute(n);if(t)return t.trim()}return``}function P(e){return e===`bottom-left`||e===`top-right`||e===`top-left`||e===`bottom-right`||e===`center`||e===`anchor`?e:`bottom-right`}function F(e){return e===`pill`||e===`badge`?e:`icon`}function I(e){return e===`minimal`||e===`glass`||e===`neo`||e===`terminal`||e===`brutalist`?e:`default`}function L(e){return e===`light`||e===`dark`?e:`auto`}function R(e,t,...n){for(let t of n)if(e.hasAttribute(t))return!z(e.getAttribute(t));return t}function z(e){return e===`false`||e===`0`||e===`no`}function B(e,t,n){e.getAttribute(t)!==n&&e.setAttribute(t,n)}function V(e,t,n){n?e.hasAttribute(t)||e.setAttribute(t,``):e.removeAttribute(t)}function H(e,t,n){n?e.style.setProperty(t,n):e.style.removeProperty(t)}function U(e,t,n,r,i,a){let o=e.top-t-r,s=e.bottom+r,c=e.top-i-r,l=n-e.bottom-i-r,u=o>=i,d=s+t<=n-i;return u||!d&&c>=l?{origin:`bottom ${a}`,top:o}:{origin:`top ${a}`,top:s}}function W(e,t,n){return Math.min(Math.max(e,t),n)}function G(e,t){let n=Array.from(t.querySelectorAll(`a[href], button:not([disabled]), input:not([disabled]), textarea:not([disabled]), select:not([disabled]), [tabindex]:not([tabindex="-1"])`)).filter(e=>e.offsetParent!==null||e===t.activeElement);if(n.length===0)return;let r=n[0],i=n[n.length-1];if(!r||!i)return;let a=t.activeElement;e.shiftKey&&a===r?(e.preventDefault(),i.focus()):!e.shiftKey&&a===i&&(e.preventDefault(),r.focus())}var K=[[`data-backdrop`,`backdrop`],[`data-close-on-outside-click`,`close-on-outside-click`],[`data-color`,`color`],[`data-custom-trigger`,`custom-trigger`],[`data-default-open`,`default-open`],[`data-initial-message`,`initial-message`],[`data-launcher-label`,`launcher-label`],[`data-launcher-variant`,`launcher-variant`],[`data-library`,`library`],[`data-panel-height`,`panel-height`],[`data-panel-width`,`panel-width`],[`data-placeholder`,`placeholder`],[`data-position`,`position`],[`data-preset`,`preset`],[`data-theme`,`theme`],[`data-title`,`title`],[`data-welcome-message`,`initial-message`],[`data-widget-id`,`widget-id`]];function q(e){if(!e||e.dataset.c7Mounted===`true`)return null;if(!e.getAttribute(`data-library`))return console.warn(`[Context7 Widget] Missing data-library attribute.`),null;O();let t=document.createElement(`context7-widget`);for(let[n,r]of K){let i=e.getAttribute(n);i!==null&&(t.setAttribute(n,i),t.setAttribute(r,i))}return e.dataset.c7Mounted=`true`,document.body.append(t),t}function J(){let e=document.currentScript;if(e instanceof HTMLScriptElement&&e.hasAttribute(`data-library`))return e;let t=document.querySelectorAll(`script[data-library]`);return t[t.length-1]??null}function Y(){q(J())}document.readyState===`loading`?document.addEventListener(`DOMContentLoaded`,Y,{once:!0}):Y()})();
